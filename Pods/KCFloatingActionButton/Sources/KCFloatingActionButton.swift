...
open class KCFloatingActionButton: UIView {
	...
	*/
    ...
    /**
        Button color.
    */
    @IBInspectable open var buttonColor: UIColor = UIColor(red: 30/255.0, green: 45/255.0, blue: 66/255.0, alpha: 1)
    ...
    */
    @IBInspectable open var plusColor: UIColor = UIColor(white: 0.76, alpha: 1)
